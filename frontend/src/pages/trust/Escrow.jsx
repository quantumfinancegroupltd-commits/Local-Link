  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <Card>
        ...
        <h1 className="mt-2 text-2xl font-bold text-slate-900 dark:text-white">How escrow works</h1>
        ...
        <div className="mt-4 grid gap-3">
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/5">
            <div className="text-sm font-semibold text-slate-900 dark:text-white">Skilled labour (jobs)</div>
            <ol className="mt-2 list-decimal pl-5 text-sm text-slate-700 dark:text-slate-400">
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/5">
            <div className="text-sm font-semibold text-slate-900 dark:text-white">Produce + delivery (orders)</div>
            <ol className="mt-2 list-decimal pl-5 text-sm text-slate-700 dark:text-slate-400">
        ...
        <div className="mt-4 rounded-2xl border border-emerald-200 bg-emerald-50/60 p-4 dark:border-emerald-500/30 dark:bg-emerald-900/20">
          <div className="text-sm font-semibold text-emerald-900 dark:text-emerald-200">When providers get paid</div>
        ...
        <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/5">
          <div className="text-sm font-semibold text-slate-900 dark:text-white">How trust scores work</div>
          <div className="mt-2 text-sm text-slate-700 dark:text-slate-400">
          ...
          <Link to="/trust/verification">
            <span className="mt-2 inline-block text-sm font-semibold text-emerald-700 dark:text-emerald-400">Learn about verification tiers →</span>
          </Link>
        </div>
