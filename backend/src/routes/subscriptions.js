...
subscriptionsRouter.get('/me', requireAuth, asyncHandler(async (req, res) => {
...
subscriptionsRouter.post('/', requireAuth, asyncHandler(async (req, res) => {
...
subscriptionsRouter.put('/:id/cancel', requireAuth, asyncHandler(async (req, res) => {
  const r = await pool.query(
