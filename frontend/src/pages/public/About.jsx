    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <Card>
        ...
        <p className="mt-3 text-sm text-slate-700">
          LocalLink is a trust + payment + coordination layer for local work and supply in Ghana. We help buyers hire skilled
          professionals and buy fresh produce with transparent rules, escrow protection, delivery coordination, and real
          reputation.
        </p>
        <div className="mt-4 rounded-2xl border bg-slate-50 p-4 text-sm text-slate-700">
          Launch focus: <span className="font-semibold">Skilled Labour</span> + <span className="font-semibold">Farm Produce</span>.
